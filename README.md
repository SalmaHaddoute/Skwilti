...
- **Génération par IA** : Créer des QCM à partir d'un simple prompt textuel
- **Upload de Documents** : Générer des QCM depuis des fichiers PDF
...
- ✅ **Génération QCM par prompt IA** (NOUVEAU)
- ✅ Dashboard administratif complet
- ✅ Classes virtuelles et collaboration
- ✅ Service QcmService dédié pour l'IA
