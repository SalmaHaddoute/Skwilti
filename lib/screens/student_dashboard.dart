    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const _SectionHeader('QSM récents'),
              ...
              child: Column(
                children: [
                  AstronautIllustration(
                    ...
                    height: 80,
                    showAnimation: true,
                    fallbackIcon: const Icon(LucideIcons.fileText, color: AppColors.textSub, size: 40),
                  ),
                  const SizedBox(height: 16),
                  ...
                  Text('Rejoignez une classe ou un room pour commencer votre aventure !',
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const _SectionHeader('Progression des scores'),
          const SizedBox(height: 12),
          _ProgressionCard(),
          const SizedBox(height: 24),
  ...
  Widget build(BuildContext context) {
    ...
    return RefreshIndicator(
      ...
      child: ListView(
        padding: const EdgeInsets.all(16).copyWith(bottom: 32),
        children: [
          const _SectionHeader('Mes classes'),
          const SizedBox(height: 10),
            ...
            if (sessions.isNotEmpty) ...[
              ...
              ...sessions.map((s) {
                ...
                return Padding(
                  ...
                  child: Row(
                    children: [
                      const Icon(LucideIcons.fileText, size: 14, color: AppColors.textSub),
                      const SizedBox(width: 8),
                      Expanded(
                        child: Text(
                          title,
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const _SectionHeader('Rooms disponibles'),
          const SizedBox(height: 12),
          ...
          const _SectionHeader('Rooms récents'),
          const SizedBox(height: 12),
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const _SectionHeader('Ma bibliothèque'),
          const SizedBox(height: 10),
...
class _FolderCard extends StatelessWidget {
  ...
  const _FolderCard({required this.title, this.course});
...
void _createStaticQsm(BuildContext context) {
  ...
  final session = QsmSession(
    ...
    courseId: null, // Pas de cours associé pour les QSM statiques
    timerMinutes: 30,
