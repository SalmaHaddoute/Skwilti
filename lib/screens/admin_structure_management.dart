              ...
              : filieres.isEmpty
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          Icon(LucideIcons.folderOpen, size: 48, color: AppColors.textSub),
              ...
              : niveaux.isEmpty
                  ? Center(
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(LucideIcons.layers, size: 48, color: AppColors.textSub),
                          const SizedBox(height: 16),
                          Text(
                            'Aucun niveau',
                            style: GoogleFonts.inter(fontSize: 16, fontWeight: FontWeight.w700, color: AppColors.text),
              ...
              : matieres.isEmpty
                  ? Center(
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(LucideIcons.bookOpen, size: 48, color: AppColors.textSub),
                          const SizedBox(height: 16),
                          Text(
                            'Aucune matière',
                            style: GoogleFonts.inter(fontSize: 16, fontWeight: FontWeight.w700, color: AppColors.text),
