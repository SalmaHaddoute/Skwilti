...
class ResultsScreen extends StatelessWidget {
  ...
  Widget _buildHero(BuildContext context, QcmSession session, double score) {
    ...
    // Choose astronaut type based on score
    final astronautType = score >= 80
        ? AstronautType.celebration
        : score >= 60
            ? AstronautType.success
            : AstronautType.learning;
    ...
    return Container(
      ...
      child: Column(
        children: [
          // Astronaut illustration above score ring
          AstronautIllustration(
            type: astronautType,
            width: 80,
            height: 80,
            showAnimation: true,
            fallbackIcon: Icon(icon, color: Colors.white, size: 40),
            fallbackColor: Colors.white.withOpacity(0.15),
          ),
          const SizedBox(height: 12),
          // Score ring
          SizedBox(
