            ...
            child: SafeArea(
              child: SingleChildScrollView(
                child: Column(children: [
                  ...
                  // ── Logo card with astronaut accent ──
                  Container(
                  ...
                  // Title + astronaut hero for login mode
                  Text(
                  ...
                  // Show astronaut hero only on login screen (not register — too long)
                  if (_isLogin) ...[
                    const SizedBox(height: 20),
                    AstronautIllustration(
                      type: AstronautType.login,
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    if (!_isLogin) ...[
                      ...
                      _Field(ctrl: _passCtrl, label: 'Mot de passe', icon: LucideIcons.lock, obscure: _obscurePass,
                        suffix: IconButton(icon: Icon(_obscurePass ? LucideIcons.eyeOff : LucideIcons.eye, size: 18, color: AppColors.textSub),
