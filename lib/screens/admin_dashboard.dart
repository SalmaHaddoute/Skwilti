  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        // Admin welcome card with astronaut
        Stack(
          children: [
                  ...
                  Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: AstronautIllustration(
                        ...
                        height: 80,
                        showAnimation: true,
                        fallbackIcon: const Icon(LucideIcons.shield, color: Colors.white, size: 40),
                      ),
                    ),
                  ),
                ],
                    ...
                    BarChartData(
                      ...
                      barTouchData: BarTouchData(
                        touchTooltipData: BarTouchTooltipData(
                          ...
                          // tooltipRoundedRadius: 8, // CORRECTION: Supprimé car n'existe pas dans fl_chart 1.2.0
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // Filter Chips
          const _SectionHeader('Filtrer par type'),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const _SectionHeader('Liste des utilisateurs'),
              ElevatedButton.icon(
      ...
      child: Column(
        ...
        children: [
          ...
          if (qsmCount != 'N/A') ...[
            Row(
              children: [
                const Icon(LucideIcons.fileText, size: 12, color: AppColors.textSub),
                const SizedBox(width: 4),
                Text(
                  qsmCount,
                  style: GoogleFonts.inter(
      ...
      child: Column(
        ...
        children: [
          ...
          AnimatedSize(
            ...
            child: isExpanded && courses.isNotEmpty
                ? Padding(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, i) => _AdminLessonCard(
                        title: courses[i]['title'] as String? ?? 'Sans titre',
                        course: courses[i],
                      ),
                    ),
                  )
...
class _AdminLessonCard extends StatelessWidget {
  ...
  const _AdminLessonCard({required this.title, this.course});
            ...
            MaterialPageRoute(
              builder: (_) => CourseDetailScreen(
                ...
                onDelete: () async {
                  ...
                  if (id.isNotEmpty) {
                    await context.read<AppState>().deleteCourse(id);
