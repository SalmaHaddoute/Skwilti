          ...
          ? classes.isEmpty
              ? Center(
                  child: Column(
                    ...
                    children: [
                      Icon(LucideIcons.graduationCap, size: 64, color: AppColors.textSub.withOpacity(0.3)),
                      ...
                      Text(
                        'Appuyez sur + pour créer une classe',
                        style: GoogleFonts.inter(
                          fontSize: 14,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Icon(LucideIcons.calendar, size: 16, color: AppColors.textSub),
              ...
              Icon(LucideIcons.users, size: 16, color: AppColors.textSub),
              const SizedBox(width: 4),
              Text(
                '$effectif étudiants',
                style: GoogleFonts.inter(fontSize: 12, color: AppColors.textSub),
