  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: SkwiltiTopNav(
        title: _idx == 0 ? 'Skwilti' : _idx == 1 ? 'Lier un enfant' : 'Contact',
        showLogo: _idx == 0,
      ...
      child: Column(
        ...
        children: [
          ...
          if (!loaded)
            ...
            // ── Weekly bar chart ─────────────────────────────────
            _SectionLabel('Activitéé de la semaine'),
            const SizedBox(height: 12),
            Container(
